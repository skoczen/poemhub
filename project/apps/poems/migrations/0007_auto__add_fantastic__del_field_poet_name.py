...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'poems_fantastic', (
            ...
            ('poet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poems.Poet'], null=True, blank=True)),
        ))
        db.send_create_signal(u'poems', ['Fantastic'])

        # Deleting field 'Poet.name'
        db.delete_column(u'poems_poet', 'name')


    def backwards(self, orm):
        # Deleting model 'Fantastic'
        db.delete_table(u'poems_fantastic')

        # Adding field 'Poet.name'
        db.add_column(u'poems_poet', 'name',
    ...
    models = {
        ...
        u'poems.fantastic': {
            ...
            'poet': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['poems.Poet']", 'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'poems.poem': {
            ...
            'written_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 23, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
