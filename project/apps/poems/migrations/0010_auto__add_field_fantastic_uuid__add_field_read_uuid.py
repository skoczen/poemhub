...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fantastic.uuid'
        db.add_column(u'poems_fantastic', 'uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Read.uuid'
        db.add_column(u'poems_read', 'uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fantastic.uuid'
        db.delete_column(u'poems_fantastic', 'uuid')

        # Deleting field 'Read.uuid'
        db.delete_column(u'poems_read', 'uuid')
    ...
    models = {
        ...
        u'poems.poem': {
            ...
            'written_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 24, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
