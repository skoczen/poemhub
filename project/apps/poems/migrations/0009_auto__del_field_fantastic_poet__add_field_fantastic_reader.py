...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Fantastic.poet'
        db.delete_column(u'poems_fantastic', 'poet_id')

        # Adding field 'Fantastic.reader'
        db.add_column(u'poems_fantastic', 'reader',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poems.Poet'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Fantastic.poet'
        db.add_column(u'poems_fantastic', 'poet',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poems.Poet'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Fantastic.reader'
        db.delete_column(u'poems_fantastic', 'reader_id')
