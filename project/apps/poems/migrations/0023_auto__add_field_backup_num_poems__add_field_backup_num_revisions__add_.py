...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Backup.num_poems'
        db.add_column(u'poems_backup', 'num_poems',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Backup.num_revisions'
        db.add_column(u'poems_backup', 'num_revisions',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Backup.num_reads'
        db.add_column(u'poems_backup', 'num_reads',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Backup.num_fantastics'
        db.add_column(u'poems_backup', 'num_fantastics',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Backup.num_poems'
        db.delete_column(u'poems_backup', 'num_poems')

        # Deleting field 'Backup.num_revisions'
        db.delete_column(u'poems_backup', 'num_revisions')

        # Deleting field 'Backup.num_reads'
        db.delete_column(u'poems_backup', 'num_reads')

        # Deleting field 'Backup.num_fantastics'
        db.delete_column(u'poems_backup', 'num_fantastics')
