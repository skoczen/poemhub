...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poem.sort_datetime'
        db.add_column(u'poems_poem', 'sort_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poem.sort_datetime'
        db.delete_column(u'poems_poem', 'sort_datetime')
    ...
    models = {
        ...
        u'poems.poem': {
            ...
            'written_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 12, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
