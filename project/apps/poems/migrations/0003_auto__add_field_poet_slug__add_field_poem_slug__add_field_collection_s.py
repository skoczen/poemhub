...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poet.slug'
        db.add_column(u'poems_poet', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Poem.slug'
        db.add_column(u'poems_poem', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=800),
                      keep_default=False)

        # Adding field 'Collection.slug'
        db.add_column(u'poems_collection', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=800),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poet.slug'
        db.delete_column(u'poems_poet', 'slug')

        # Deleting field 'Poem.slug'
        db.delete_column(u'poems_poem', 'slug')

        # Deleting field 'Collection.slug'
        db.delete_column(u'poems_collection', 'slug')
    ...
    models = {
        ...
        u'poems.collection': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '800'}),
