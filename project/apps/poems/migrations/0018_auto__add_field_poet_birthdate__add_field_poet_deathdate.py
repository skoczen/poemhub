...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poet.birthdate'
        db.add_column(u'poems_poet', 'birthdate',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Poet.deathdate'
        db.add_column(u'poems_poet', 'deathdate',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poet.birthdate'
        db.delete_column(u'poems_poet', 'birthdate')

        # Deleting field 'Poet.deathdate'
        db.delete_column(u'poems_poet', 'deathdate')
