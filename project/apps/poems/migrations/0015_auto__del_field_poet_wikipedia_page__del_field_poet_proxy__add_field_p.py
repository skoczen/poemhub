...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Poet.wikipedia_page'
        db.delete_column(u'poems_poet', 'wikipedia_page')

        # Deleting field 'Poet.proxy'
        db.delete_column(u'poems_poet', 'proxy')

        # Adding field 'Poet.wikipedia_url'
        db.add_column(u'poems_poet', 'wikipedia_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Poet.archive'
        db.add_column(u'poems_poet', 'archive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Poet.archive_name'
        db.add_column(u'poems_poet', 'archive_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'Poet.user'
        db.alter_column(u'poems_poet', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):
        # Adding field 'Poet.wikipedia_page'
        db.add_column(u'poems_poet', 'wikipedia_page',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Poet.wikipedia_url'
        db.delete_column(u'poems_poet', 'wikipedia_url')

        # Deleting field 'Poet.archive'
        db.delete_column(u'poems_poet', 'archive')

        # Deleting field 'Poet.archive_name'
        db.delete_column(u'poems_poet', 'archive_name')


        # Changing field 'Poet.user'
        db.alter_column(u'poems_poet', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
    ...
    models = {
        ...
        u'poems.poem': {
            ...
            'written_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 9, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
