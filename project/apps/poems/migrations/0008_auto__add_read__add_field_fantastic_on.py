...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'poems_read', (
            ...
            ('reader', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poems.Poet'], null=True, blank=True)),
        ))
        db.send_create_signal(u'poems', ['Read'])

        # Adding field 'Fantastic.on'
        db.add_column(u'poems_fantastic', 'on',
    ...
    def backwards(self, orm):
        # Deleting model 'Read'
        db.delete_table(u'poems_read')

        # Deleting field 'Fantastic.on'
        db.delete_column(u'poems_fantastic', 'on')
