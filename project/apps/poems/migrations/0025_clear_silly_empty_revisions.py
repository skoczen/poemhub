...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for p in orm.PoemRevision.objects.filter(title="Title", body="Body"):
            p.delete()
    ...
    models = {
        ...
        u'poems.poem': {
            ...
            'written_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 20, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
