...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoemRevision.approximate_publication_date'
        db.add_column(u'poems_poemrevision', 'approximate_publication_date',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PoemRevision.source_url'
        db.add_column(u'poems_poemrevision', 'source_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Poem.source_url'
        db.add_column(u'poems_poem', 'source_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PoemRevision.approximate_publication_date'
        db.delete_column(u'poems_poemrevision', 'approximate_publication_date')

        # Deleting field 'PoemRevision.source_url'
        db.delete_column(u'poems_poemrevision', 'source_url')

        # Deleting field 'Poem.source_url'
        db.delete_column(u'poems_poem', 'source_url')
