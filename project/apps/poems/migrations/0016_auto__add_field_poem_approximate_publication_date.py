...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poem.approximate_publication_date'
        db.add_column(u'poems_poem', 'approximate_publication_date',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poem.approximate_publication_date'
        db.delete_column(u'poems_poem', 'approximate_publication_date')
