...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Poem.date_written'
        db.delete_column(u'poems_poem', 'date_written')

        # Adding field 'Poem.written_on'
        db.add_column(u'poems_poem', 'written_on',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 4, 17, 0, 0), null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Poem.date_written'
        db.add_column(u'poems_poem', 'date_written',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 4, 17, 0, 0), null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Poem.written_on'
        db.delete_column(u'poems_poem', 'written_on')
    ...
    models = {
        ...
        u'poems.poem': {
            ...
            'written_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 17, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
