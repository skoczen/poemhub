...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoemRevision.longest_line'
        db.add_column(u'poems_poemrevision', 'longest_line',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PoemRevision.longest_line'
        db.delete_column(u'poems_poemrevision', 'longest_line')
