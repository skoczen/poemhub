...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poem.display_type'
        db.add_column(u'poems_poem', 'display_type',
                      self.gf('django.db.models.fields.CharField')(default='poetry', max_length=50),
                      keep_default=False)

        # Adding field 'PoemRevision.display_type'
        db.add_column(u'poems_poemrevision', 'display_type',
                      self.gf('django.db.models.fields.CharField')(default='poetry', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poem.display_type'
        db.delete_column(u'poems_poem', 'display_type')

        # Deleting field 'PoemRevision.display_type'
        db.delete_column(u'poems_poemrevision', 'display_type')
